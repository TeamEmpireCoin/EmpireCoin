...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("EmpireCoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EmpireCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"EmpireCointools.com", "dnsseed.EmpireCointools.com"},
    {"EmpireCoinpool.org", "dnsseed.EmpireCoinpool.org"},
...
unsigned int pnSeed[] =
{
    ...
    0x4b05fb94, 0x0c44c052, 0xf403f45c, 0x4333aa6b, 0xc233384d, 0x3fbf5d4c, 0x0bd7f74d, 0x150e3fb2,
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EmpireCoin is probably already running."), addrBind.ToString().c_str());
        else
