...
{
    BOOST_CHECK(TestSplitHost("www.EmpireCoin.org", "www.EmpireCoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.EmpireCoin.org]", "www.EmpireCoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.EmpireCoin.org:80", "www.EmpireCoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.EmpireCoin.org]:80", "www.EmpireCoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:23348", "127.0.0.1", 23348));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:23348", "127.0.0.1", 23348));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:23348", "::ffff:127.0.0.1", 23348));
    BOOST_CHECK(TestSplitHost("[::]:23348", "::", 23348));
    BOOST_CHECK(TestSplitHost("::23348", "::23348", -1));
    BOOST_CHECK(TestSplitHost(":23348", "", 23348));
    BOOST_CHECK(TestSplitHost("[]:23348", "", 23348));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:23348", "127.0.0.1:23348"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:23348", "[::]:23348"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
