...
/**
  EmpireCoin GUI main class. This class represents the main window of the EmpireCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class EmpireCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit EmpireCoinGUI(QWidget *parent = 0);
    ~EmpireCoinGUI();
    ...
    */
    ...
    QAction * getEasyvoteAction() { return easyvoteAction; }
