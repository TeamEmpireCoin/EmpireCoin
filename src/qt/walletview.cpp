...
WalletView::WalletView(QWidget *parent, EmpireCoinGUI *_gui):
...
void WalletView::setEmpireCoinGUI(EmpireCoinGUI *gui)
{
    this->gui = gui;
}
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        easyvotePage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    if (walletModel)
    {
        ...
        votingPage->setModel(walletModel->getVotingTableModel());
        easyvotePage->setWalletModel(walletModel);
...
{
    gui->getVotingAction()->setChecked(true);
    setCurrentWidget(votingPage);
}

void WalletView::gotoEasyvotePage()
{
    gui->getEasyvoteAction()->setChecked(true);
    setCurrentWidget(easyvotePage);
}
