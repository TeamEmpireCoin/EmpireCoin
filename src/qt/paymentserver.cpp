...
const QString BITCOIN_IPC_PREFIX("EmpireCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click EmpireCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start EmpireCoin: click-to-pay handler");
    else
...
{
    // clicking on EmpireCoin: URLs creates FileOpen events on the Mac:
