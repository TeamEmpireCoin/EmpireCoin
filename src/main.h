...
static const unsigned int MAX_BLOCK_SIZE = 5000000;                      // 5000KB block hard limit
/** Obsolete: maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/4;         // 1250KB  block soft limit
...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 EMP
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 EMP mininput
...
public:
    ...
    */
    ...
    /** Amount of EmpireCoins spent by this transaction.
    ...
    /** Amount of EmpireCoins coming in to this transaction
...
void UpdateCoins(const CTransaction& tx, CValidationState &state, CCoinsViewCache &inputs, CTxUndo &txundo, int nHeight, const uint256 &txhash);
    ...
    std::string ToString() const
    {
        ...
        for (unsigned int i = 0; i < vout.size(); i++)
        {
            ...
            CScript curScriptPubKey = vout[i].scriptPubKey;
 ...
 *               * 8358: compact amount representation for 60000000000 (600 EMP)
 ...
 *             * 86ef97d579: compact amount representation for 234925952 (2.35 EMP)
 *             * 00: special txout type pay-to-pubkey-hash
 *             * 61b01caab50f1b8e9c50a5057eb43c2d9563a4ee: address uint160
 *  - vout[16]: bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4
 *              * bbd123: compact amount representation for 110397 (0.001 EMP)
 *              * 00: special txout type pay-to-pubkey-hash
