...
unlocked to sign the EmpireCoin-Qt.app bundle.
...
allowing somebody to distribute a EmpireCoin-Qt.app or EmpireCoin-qt-setup.exe with a valid
...
that the EmpireCoin-qt.exe file inside the installer had not been tampered with.
