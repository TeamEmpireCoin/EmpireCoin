...
BITCOIND=${1}/EmpireCoind
CLI=${1}/EmpireCoin-cli
...
echo "Done, EmpireCoind's shut down. To rerun/poke around:"
echo "${1}/EmpireCoind -datadir=$D1 -daemon"
echo "${1}/EmpireCoind -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall EmpireCoind; rm -rf test.*"
exit 0
